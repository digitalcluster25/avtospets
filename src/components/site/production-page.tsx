...
const typeCards = [
  ...
  },
  {
    letter: "B",
    title: "Тип B",
    body: "Автомобіль екстреної допомоги для базової підтримки пацієнта під час транспортування та роботи медичної бригади.",
  },
  {
    letter: "C",
    title: "Тип C",
    body: "Реанімаційний автомобіль для інтенсивної терапії, розширеного оснащення та роботи спеціалізованої бригади.",
  },
] as const;

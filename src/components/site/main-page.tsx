...
const pageCopy = {
  ua: {
    ...
    heroCards: [
      {
        ...
        href: "/production",
        image: "/figma/hero409/hero-image.webp",
        imageAlt: "Виробництво автомобілів швидкої допомоги",
      },
      {
        title: "Соціальний транспорт",
        description:
          "Спеціалізований транспорт для людей з обмеженими фізичними можливостями, мобільні амбулаторії, перевезення маломобільних груп населення на базі Peugeot Boxer та Citroen Berlingo.",
        button: "Детальніше про соціальний транспорт",
        href: "/production",
        image: "/figma/ambulance-cards/spets1.png",
    ...
    chassisTitle: "Базові автомобілі",
    chassisBody:
      'Зазначені типи "швидких" виробляються на базі автомобілів Citroën, Peugeot, Ford, Mercedes-Benz',
    chassisNote:
  ...
  return (
    <div className={styles.page}>
      ...
      <main>
        ...
        <section className={`${styles.sectionLight} ${styles.partnersSectionLight}`}>
